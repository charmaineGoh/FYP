...
async function populateDashboard() {
  try {
    //date filter values if they exist
    ...
    const [stocks, movements] = await Promise.all(fetchPromises);
    ...
    // Apply date filtering when dates are selected
